...
%   xkrenem00-20-literatura-bibliography.bib - literatura / bibliography
%   xkrenem00-01-kapitoly-chapters.tex - obsah práce / the thesis content
%   xkrenem00-01-kapitoly-chapters-en.tex - obsah práce v angličtině / the thesis content in English
%   xkrenem00-30-prilohy-appendices.tex - přílohy / appendices
%   xkrenem00-30-prilohy-appendices-en.tex - přílohy v angličtině / appendices in English
%==============================================================================
\documentclass[zadani,cprint]{fitthesis} % bez zadání - pro začátek práce, aby nebyl problém s překladem
...
\projectinfo{
  ...
  title.cs={Opravování defektů fotogrammetrické 3D rekonstrukce s využitím strojového učení},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Repairing Photogrammetric 3D Reconstruction Defects using Machine Learning}, % název práce v angličtině / thesis title in english
  ...
  %Autor / Author
  author.name={Matěj},   % jméno autora / author name
  ...
  supervisor.surname={Španěl},   % příjmení školitele / supervisor surname
...
\begin{document}
  ...
  % ----------------------------------------------
  % \ifenglish
  %  \input{xkrenem00-01-kapitoly-chapters-en}
  % \else
  %  \input{xkrenem00-01-kapitoly-chapters}
  %\fi
  
  % Kompilace po částech (viz výše, nutno odkomentovat a zakomentovat input výše)
  % Compilation piecewise (see above, it is necessary to uncomment it and comment out input above)
  \subfile{chapters/xkrenem00-01-uvod-introduction}
  % ...
  %\subfile{chapters/xkrenem00-05-zaver-conclusion}
...
\fi
  \begin{flushleft}
  \bibliography{xkrenem00-20-literatura-bibliography}
  \end{flushleft}
...
\fi
  ...
  % Přílohy / Appendices
  \ifenglish
    \input{xkrenem00-30-prilohy-appendices-en}
  \else
    \input{xkrenem00-30-prilohy-appendices}
  \fi
  
  % Kompilace po částech (viz výše, nutno odkomentovat)
  % Compilation piecewise (see above, it is necessary to uncomment it)
  %\subfile{xkrenem00-30-prilohy-appendices}
