...
File: transformer.py
Responsibility: Transformer and graph-attention building blocks used by the PoinTr model.
...
Attribution:
    ...
    The adaptation preserves attention and decoder behavior while integrating local
    utility abstractions and repository conventions.
"""
