...
File: dgcnn.py
Responsibility: DGCNN-based local grouping and downsampling module used by PoinTr encoder input processing.
...
Attribution:
    ...
    The adaptation preserves grouping behavior while using local utility wrappers
    for KNN and FPS operations.
"""

import torch
from torch import nn
from .utils import fps_indices, gather_operation, knn_points
...
class DGCNN_Grouper(nn.Module):
    ...
    def fps_downsample(coor, x, num_group):
        ...
        new_combined_x = gather_operation(combined_x, fps_idx)
